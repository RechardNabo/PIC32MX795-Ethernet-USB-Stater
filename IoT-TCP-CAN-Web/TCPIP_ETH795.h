...
#define STACK_USE_UPDChangeIP				// Master Power change IP through UDP
...
#define MY_DEFAULT_MAC_BYTE6            (0x00)	// Liaan UC address instead.
//#define MY_DEFAULT_MAC_BYTE6            (0x07)	// address instead.

#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (18ul)
#define MY_DEFAULT_IP_ADDR_BYTE4        (22ul)   // Default IP Address
...
#define MY_DEFAULT_GATE_BYTE3           (18ul)
#define MY_DEFAULT_GATE_BYTE4           (1ul)     // Default Gateway

#define MY_DEFAULT_PRIMARY_DNS_BYTE1	(8ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE2	(8ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(8ul)
#define MY_DEFAULT_PRIMARY_DNS_BYTE4	(8ul)      // Google Primary DNS
...
#define EMAC_TX_BUFF_SIZE               1500            // maximum size of an TX packet
#define EMAC_RX_DESCRIPTORS		20//8		// number of the RX descriptors and RX buffers to be created

#define	EMAC_RX_BUFF_SIZE		1536	// 1536 size of a RX buffer. should be multiple of 16
 ...
 */
	...
	#define TCP_PIC_RAM_SIZE					(46384ul)//16384ul
//	#define TCP_PIC_RAM_SIZE					(36384ul)//16384ul
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
			...
			{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_PIC_RAM, 125, 1200},
			{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_PIC_RAM, 125, 1200},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 600, 260},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 600, 260},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 600, 260},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 600, 260},
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_PIC_RAM, 600, 260},
...
//			{TCP_PURPOSE_FTP_DATA, TCP_PIC_RAM, 0, 128},
			...
			{TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 1600, 1500},
			{TCP_PURPOSE_HTTP_SERVER, TCP_PIC_RAM, 1600, 1500},
			//{TCP_PURPOSE_DEFAULT, TCP_PIC_RAM, 1000, 1000},
//			{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 600, 260},
//			{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 600, 260},
//			{TCP_PURPOSE_BERKELEY_SERVER, TCP_PIC_RAM, 600, 260},
