...
void GenericTCPServer(devices *object);
void ModbusTCPClientTask(void);

// Main.c
void FuelSensorTask(void);
void Heartbeat (void);
void BVT840Task (void);
void BVT840Init(void);
void InitilizeModbusServers(void);
 
// Battery Manager Tasks
void BatteryManagerTasks(void);
void InitilizeBatteryManager(void);
// Card Reader
void AccessControlOrSecurityTasks(void);
